...
rm -rf /disk/scratch/s1303513/results_t2
...
rsync -av ./embeddings/ft/ar_vectors/ar_vectors_t2.txt /disk/scratch/s1303513/ar_vectors_t2.txt
...
allennlp train ./git2/embedding_bias/coref/coref_config_file_t2 -s /disk/scratch/s1303513/results_t2
