...
rm -rf /disk/scratch/s1303513/results_bl_w2v
...
rsync -av ./embeddings/w2v/db_d_6_vectors_w2v.txt /disk/scratch/s1303513/db_d_6_vectors_w2v.txt
...
allennlp train ./git2/embedding_bias/coref/coref_config_file_db -s /disk/scratch/s1303513/results_db_d_6_w2v
