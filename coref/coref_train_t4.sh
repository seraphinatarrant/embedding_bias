...
rsync -av ./embeddings/ft/ar_vectors/ar_vectors_t4.txt /disk/scratch/s1303513/ar_vectors_t4.txt
...
allennlp train ./git2/embedding_bias/coref/coref_config_file_t4 -s /disk/scratch/s1303513/results_t4
