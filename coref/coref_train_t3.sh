...
rsync -av ./embeddings/ar_vectors/ar_vectors_t3.txt /disk/scratch/s1303513/ar_vectors_t3.txt
...
allennlp train ./git2/embedding_bias/coref/coref_config_file_t3 -s /disk/scratch/s1303513/results_t3
