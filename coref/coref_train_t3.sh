...
rm -rf /disk/scratch/s1303513/results_t3_w2v
...
rsync -av ./embeddings/w2v/ar_vectors/w2v_ar_vectors_t3.txt /disk/scratch/s1303513/w2v_ar_vectors_t3.txt
...
allennlp train ./git2/embedding_bias/coref/coref_config_file_t3 -s /disk/scratch/s1303513/results_t3_w2v
