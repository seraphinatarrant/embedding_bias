...
rsync -av ./embeddings/w2v/ar_vectors/w2v_vectors_gl.txt /disk/scratch/s1303513/w2v_vectors_bl.txt
...
allennlp train ./git2/embedding_bias/coref/coref_config_file_bl -s /disk/scratch/s1303513/results_bl_w2v
