...
rsync -av ./embeddings/w2v/ar_vectors/w2v_ar_vectors_t5.txt /disk/scratch/s1303513/w2v_ar_vectors_t5.txt
...
allennlp train ./git2/embedding_bias/coref/coref_config_file_t5 -s /disk/scratch/s1303513/results_t5_w2v
