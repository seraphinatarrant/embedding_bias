...
python ./git2/embedding_bias/dataset_balancing/db_debias.py /disk/scratch/s1303513/wiki_new_final_copy.txt /disk/scratch/s1303513/db_debias_data_6.txt 6

echo Copying data back to home directory

rsync -av /disk/scratch/s1303513/db_debias_data_6.txt ./db_debias_data_6.txt
