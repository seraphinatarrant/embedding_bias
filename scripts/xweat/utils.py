"""
This is the code from https://github.com/anlausch/XWEAT, with some minor
modifications to some flags. Just made sure that methods in this file get
passed word2vec=True
"""
